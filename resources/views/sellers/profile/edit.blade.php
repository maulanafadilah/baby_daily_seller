    ...
    <div class="wide-block pb-1 pt-1">
        <form action="{{ route('profile.update',$id) }}" method="POST">
            ...
            <ul class="listview image-listview no-line no-space flush">
                <li>
                    <div class="item">
                        <img src="{{ asset('/img/bukalapak.png') }}" alt="image" class="imaged w36 me-1 ">
                        <div class="in">
                ...
                <li>
                    <div class="item">
                        <img src="{{ asset('/img/shopee.png') }}" alt="image" class="imaged w36 me-1">
                        <div class="in">
                            <div class="form-group basic">
                                <div class="input-wrapper">
                ...
                <li>
                    <div class="item">
                        <img src="{{ asset('/img/tokopedia.png') }}" alt="image" class="imaged w36 me-1">
                        <div class="in">
                            <div class="form-group basic">
                                <div class="input-wrapper">
...
<div class="section tex-center">
    <button class="btn btn-outline-info mt-2 btn-block" onclick="show()">Ubah Jam Operasional</button>
</div>
<div class="section">
<div id="target" style="display: none;" class="mt-4">
    <form action="{{ route('profile.update',$id) }}" method="POST">
        @method('PUT')
        @csrf
        <div class="row">
