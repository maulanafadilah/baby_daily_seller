...
<div class="section mt-3">
    <div class="avatar" style="text-align:center">
        ...
        <img src="https://res.cloudinary.com/baby-daily-indonesia/image/upload/w_64,c_fill,ar_1:1,g_auto,r_max/{{$sellers->foto_penjual}}" alt="foto_profile">
        @else
        <img src="{{ asset('assets/img/sample/avatar/avatar1.jpg')}}" alt="avatar" class="imaged w64 rounded">
        @endif
    </div>
    <div class="in mt-1" style="text-align:center">
        <a href="{{ route('profile.edit',7) }}" class="text-primary">Ubah Foto Profil</a>
    </div>
</div>
